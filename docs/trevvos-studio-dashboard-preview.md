...
8. usar o atalho do template Tecnico Editorial ou criar um template manualmente
9. abrir `/app/tenants/{tenantId}/requests/new`
10. criar um content request
11. abrir `/app/tenants/{tenantId}/requests/{requestId}`
12. usar `Gerar draft com IA` ou criar/editar o draft manualmente
13. rodar `Verificar qualidade do draft`
14. revisar o draft e ajustar se necessario
15. usar `Submeter texto para aprovacao`
16. usar `Aprovar texto`
17. selecionar um template visual e usar `Gerar Render Specs`
18. usar `Renderizar imagens`
19. validar os PNGs no grid e abrir o asset em nova aba
